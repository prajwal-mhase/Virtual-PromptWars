  ...
  return (
    <main className="min-h-screen">
      <section className="relative flex min-h-[92vh] items-center overflow-hidden px-6 py-16">
        <div className="absolute inset-0 -z-10 bg-[url('https://images.unsplash.com/photo-1518604666860-9ed391f76460?auto=format&fit=crop&w=2400&q=80')] bg-cover bg-center opacity-28 dark:opacity-22" />
